...
class Game {
    ...
    constructor () {
        ...
        this.score = 0; //Puntuación del usuario
    }
    ...
    /**
     * Comprueba si el personaje principal y el oponente se han chocado entre sí o con los disparos haciendo uso del método hasCollision
     */
    checkCollisions () {
        let impact = false;
